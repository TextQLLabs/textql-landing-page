  ...
  return (
    <section className="bg-transparent py-24 relative overflow-hidden">
      <div className="mx-auto max-w-4xl px-6 relative">
        <div className="bg-black border border-[#729E8C]/20 rounded-xl p-12 relative">
          ...
          <div className="space-y-8">
            <div className="space-y-6">
              ...
              <Text color="primary" className="text-2xl md:text-3xl font-light leading-relaxed italics">
                {quote}
              </Text>
            </div>
