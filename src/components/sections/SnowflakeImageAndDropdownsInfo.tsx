...
const SnowflakeImageAndDropdownsInfo = () => {
  ...
  const accordionData = [
    ...
    },
    {
      ...
      content: (
        <div>
          <p className="mb-3">See our proprietary Mission Control Platform integrated with Snowflake</p>
          <ul className="space-y-2 list-disc pl-4">
            <li>Explore synthetic Snowflake environment setup</li>
...
export default SnowflakeImageAndDropdownsInfo; 